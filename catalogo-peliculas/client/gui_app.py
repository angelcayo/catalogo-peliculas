...
class Frame(tk.Frame):
    ...
    def campos_pelicula(self):
        ...
        # Entry de cada campo
        self.str_nombre = tk.StringVar()
        self.entry_nombre = tk.Entry(self, textvariable=self.str_nombre)
        self.entry_nombre.config(width=50, font=('Arial', 12))
        self.entry_nombre.grid(row=0, column=1, padx=10, pady=10, columnspan=2)

        self.str_duracion = tk.StringVar()
        self.entry_duracion = tk.Entry(self, textvariable=self.str_duracion)
        self.entry_duracion.config(width=50, font=('Arial', 12))
        self.entry_duracion.grid(
            row=1, column=1, padx=10, pady=10, columnspan=2)

        self.str_genero = tk.StringVar()
        self.entry_genero = tk.Entry(self, textvariable=self.str_genero)
        ...
        self.button_guardar.config(width=20, font=(
        ...
        self.button_cancelar.config(width=20, font=(
    ...
    def tabla_peliculas(self):
        ...
        self.tabla = ttk.Treeview(self, columns=('ID', 'Nombre', 'Duración', 'Genero'))
        ...
        self.button_editar.config(width=20, font=(
            'Arial', 12, 'bold'), fg='#DAD5D6', bg='#158645', cursor='hand2', activebackground='#35BD6F')
        ...
        self.button_eliminar.config(width=20, font=(
            'Arial', 12, 'bold'), fg='#DAD5D6', bg='#BD152E', cursor='hand2', activebackground='#E15370')
        self.button_eliminar.grid(row=5, column=1, padx=10, pady=10)

    def editar_datos(self):
        try:
            self.pelicula = self.tabla.item(self.tabla.selection())

            self.id_pelicula = self.pelicula['text']
            self.nombre_pelicula = self.pelicula['values'][0]
            self.duracion_pelicula = self.pelicula['values'][1]
            self.genero_pelicula = self.pelicula['values'][2]
            ...
            messagebox.showerror('Edicion ed datos', 'No ha seleccionado ningun registro')
